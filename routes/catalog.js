...
// GET request for creating genre. Note this must come before route that displays Genre (uses id)
...
// GET request for creating bookinstance. Note this must come before route that displays bookinstance (uses id)
